...
public class StrRule
{
	...
	StrRule (string predecessor, string sucessor, float probability)
	{
	...
	public static StrRule Build (string line)
	{
		...
		return new StrRule (predecessor, successor, probability);
	}
